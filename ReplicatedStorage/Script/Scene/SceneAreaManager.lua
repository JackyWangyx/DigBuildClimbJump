...
function SceneAreaManager:GetCurrentAreaIndex()
	return SceneAreaManager.CurrentAreaIndex
end

function SceneAreaManager:GetCurrentAreaInfo()
	return SceneAreaManager.AreaInfoList[SceneAreaManager.CurrentAreaIndex]
end
...
function SceneAreaManager:GetCurrentThemeInfo()
	local areaInfo = SceneAreaManager:GetCurrentAreaInfo()
...
function SceneAreaManager:RefreshServerAreaInfo(serverAreaInfoList)
	...
	--warn(SceneAreaManager.AreaInfoList, serverAreaInfoList)
