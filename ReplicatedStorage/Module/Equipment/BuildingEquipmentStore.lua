...
local BuildingEquipmentStore = {}

function BuildingEquipmentStore:Init(buildingPart, opts)
	local building = Building.TriggerOpenUI(buildingPart, opts, "EquipmentStore")
end

return BuildingEquipmentStore
