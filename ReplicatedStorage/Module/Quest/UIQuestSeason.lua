...
function UIQuestSeason:Init(root)
	...
	UIQuestSeason.PremiumFrame = UIIndexManager:GetChildByName(root, "PremiumFrame")
	UIQuestSeason.QuestFrame = UIIndexManager:GetChildByName(root, "QuestFrame")
	UIQuestSeason.SeasonFrame = UIIndexManager:GetChildByName(root, "SeasonFrame")
	UIQuestSeason.SeasonLootFrame = UIIndexManager:GetChildByName(root, "SeasonLootFrame")
	UIQuestSeason.PassFrame = UIIndexManager:GetChildByName(UIQuestSeason.SeasonFrame, "PassFrame")
	
	UIQuestSeason.DailyFrame = UIIndexManager:GetChildByName(UIQuestSeason.QuestFrame, "DailyFrame")
	UIQuestSeason.DailyCountDown = UIIndexManager:GetChildByName(UIQuestSeason.DailyFrame, "Text_CountDown")
	UIQuestSeason.WeeklyFrame = UIIndexManager:GetChildByName(UIQuestSeason.QuestFrame, "WeeklyFrame")
	UIQuestSeason.WeeklyCountDown = UIIndexManager:GetChildByName(UIQuestSeason.WeeklyFrame, "Text_CountDown")
end
