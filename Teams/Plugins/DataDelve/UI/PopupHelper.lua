...
function PopupHelper.attachDropShadow(object: GuiObject)
	...
	local function update()
		if dropShadow.Parent then
			dropShadow.Position = UDim2.fromOffset((object.AbsolutePosition.X - dropShadow.Parent.AbsolutePosition.X) - 15, (object.AbsolutePosition.Y - dropShadow.Parent.AbsolutePosition.Y) - 9)
